...
pandaUid=p.loadURDF("franka_panda/panda.urdf",useFixedBase=True)   #机械臂
tableUid=p.loadURDF("table/table.urdf",basePosition=[0.5,0,-0.65]) #桌子
trayUid=p.loadURDF("tray/traybox.urdf",basePosition=[0.65,0,0])    #盒子
